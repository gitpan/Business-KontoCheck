...
kto_check_pz(pz,kto...)
   ...
   char *kto;
PREINIT:
#line 159 "KontoCheck.lx"
   char *blz;
CODE:
#line 161 "KontoCheck.lx"
   switch(items){
      case 2:
         blz=NULL;
         break;
...
lut_init(...)
PREINIT:
#line 185 "KontoCheck.lx"
   char *lut_name;
   unsigned int required;
   unsigned int set;
CODE:
#line 189 "KontoCheck.lx"
   switch(items){
      case 0:
         lut_name=NULL;
...
kto_check_init(lut_name...)
   char *lut_name
PREINIT:
#line 223 "KontoCheck.lx"
   unsigned int required;
   unsigned int set;
   unsigned int incremental;
CODE:
#line 227 "KontoCheck.lx"
   switch(items){
      case 1:
         required=DEFAULT_INIT_LEVEL;
         set=0;
...
#line 412 "KontoCheck.lx"
char *
pz2str(pz...)
   int pz;
CODE:
   int ret;
#line 419 "KontoCheck.lx"
...
PPCODE:
   ...
   if(ret<0){  /* Fehler beim Funktionsaufruf */
      XSRETURN(0);
   }
...
generate_lut_at(inputname,outputname...)
   ...
   char *outputname;
PREINIT:
#line 821 "KontoCheck.lx"
   char *plain_name;
   char *plain_format;
CODE:
#line 824 "KontoCheck.lx"
   if(items==2){
      plain_name=NULL;
      plain_format=NULL;
   }
