...
generate_lut_at(inputname,outputname...)
   ...
   char *outputname;
PREINIT:
#line 1084 "KontoCheck.lx"
   char *plain_name;
   char *plain_format;
CODE:
#line 1087 "KontoCheck.lx"
   if(items==2){
      plain_name=NULL;
      plain_format=NULL;
   }
