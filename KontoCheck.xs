...
kto_check_pz(pz,kto...)
   ...
   char *kto;
PREINIT:
#line 158 "KontoCheck.lx"
   char *blz;
CODE:
#line 160 "KontoCheck.lx"
   switch(items){
      case 2:
         blz=NULL;
         break;
...
#line 411 "KontoCheck.lx"
char *
pz2str(pz...)
   int pz;
CODE:
   int ret;
#line 418 "KontoCheck.lx"
...
generate_lut_at(inputname,outputname...)
   ...
   char *outputname;
PREINIT:
#line 815 "KontoCheck.lx"
   char *plain_name;
   char *plain_format;
CODE:
#line 818 "KontoCheck.lx"
   if(items==2){
      plain_name=NULL;
      plain_format=NULL;
   }
