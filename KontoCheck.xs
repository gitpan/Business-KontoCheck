...
kto_check_pz(pz,kto...)
   ...
   char *kto;
PREINIT:
#line 137 "KontoCheck.lx"
   char *blz;
CODE:
#line 139 "KontoCheck.lx"
   switch(items){
      case 2:
         blz=NULL;
         break;
